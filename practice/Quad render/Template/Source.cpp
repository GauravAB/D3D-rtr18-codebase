...
HRESULT initialize(void)
{
	...
	compile_and_create_vertex_shader(gpID3D11Device, gpID3D11DeviceContext, gpID3D11VertexShader, gpID3D11InputLayout, L"vertexShader.hlsl", gpFile);
	compile_and_create_pixel_shader(gpID3D11Device,gpID3D11DeviceContext, gpID3D11PixelShader,L"fragmentShader.hlsl",gpFile);
	...
	//init quad resource
	quad::init(gpID3D11Device,gpID3D11DeviceContext);
...
void display(void)
{
	...
	*/
	quad::setVertexBufferAndTopology(gpID3D11Device,gpID3D11DeviceContext);
