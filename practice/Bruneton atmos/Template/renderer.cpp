...
namespace renderer
{
	...
	ID3D11ShaderResourceView* earth_cloud_texture;
	ID3D11ShaderResourceView* earth_night_texture;
	...
	//	LoadD3DTexture(pID3D11Device, pID3D11DeviceContext, L"earthNoClouds.bmp", &earth_texture);
